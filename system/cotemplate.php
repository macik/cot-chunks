...
class XTemplate
{
	...
	/**
	 * Register extender to handle custom tags
	 *
	 * Format:
	 * 	TAG PCRE => Name of handler function
	 *
	 * Example:
	 * <code>
	 * $extenders = array(
	 ...
	 * </code>
	 *
	 * @param array $extenders Array of Tag token => handler function pairs
	 */
	public static function set_extender($extenders = array())
	{
		self::$extender_registry = array_merge(self::$extender_registry, $extenders);
	}
	...
	public function compile($code)
	{
		...
		$this->extender_handler_list = array();
		return $this;
	}
