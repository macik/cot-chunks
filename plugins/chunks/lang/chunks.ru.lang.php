...
$L['cfg_throw_exception'] =array('Всегда использовать исключения при найденных ошибках при обработке чанков','иначе только в режиме отладки сайта (`debug_mode`)'); // cfg l10n
